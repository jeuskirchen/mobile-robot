...
# List to store sensor hit points and robot position points 
hit_points = []
pos_points = []
...
while running:
    ...
    if (robot_x, robot_y) not in pos_points: 
        pos_points.append((robot_x, robot_y)) 
    ...
    for obs in obstacles:
        ...
        pygame.draw.rect(screen, BACKGROUND_COLOR, obs)
